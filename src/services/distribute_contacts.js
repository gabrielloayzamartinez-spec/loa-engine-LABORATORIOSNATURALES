...
export async function runDistributeContacts() {
  console.log("\n=================================================");
  console.log("[DISTRIBUTE] DISTRIBUCIÓN MASIVA AL PIPELINE MAESTRO");
  ...
  console.log("[DISTRIBUTE] Consultando todos los contactos del CRM...");
  while (url) {
  ...
  console.log(`\n[DISTRIBUTE] Total contactos a inyectar en el Pipeline: ${allContacts.length}\n`);
  ...
  console.log(`\n[DISTRIBUTE] DISTRIBUCIÓN AL PIPELINE MAESTRO FINALIZADA:`);
  console.log(`=================================================`);
  console.log(`[DISTRIBUTE] Total de Oportunidades Creadas: ${successTotal}`);
  console.log(`[DISTRIBUTE] 1. En 'Precalificado' (Sin Teléfono): ${precalificados} (${(((precalificados)/successTotal)*100).toFixed(1)}%)`);
  console.log(`[DISTRIBUTE] 2. En 'Calificado'   (Con Teléfono): ${calificados} (${(((calificados)/successTotal)*100).toFixed(1)}%)`);
  console.log(`=================================================\n`);
}
