...
function showMenu() {
  console.log("\n=================================================");
  console.log("   [CLI] PANEL DE CONTROL MAESTRO & RADAR MULTI-TOUCH");
  console.log("=================================================");
  ...
  rl.question("Elige una opción (1-7): ", async (ans) => {
    switch (ans.trim()) {
      ...
      case '4':
        ...
        break;
      case '5':
        console.log("\n[CLI] Iniciando Servidor 24/7 y Dashboard...");
      ...
      case '6':
        ...
        break;
      case '7':
        console.log("[CLI] Saliendo del Panel de Control.");
        process.exit(0);
      default:
        console.log("[CLI] [ERROR] Opción inválida. Intenta nuevamente.");
        showMenu();
        break;
    }
  });
