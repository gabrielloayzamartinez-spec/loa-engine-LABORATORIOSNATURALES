...
async function runTests() {
  console.log('\n==========================================================');
  console.log('[TEST] SUITE DE PRUEBAS: Curador Bi-Direccional Multi-Sede');
  console.log('==========================================================\n');
  ...
  // Test 4: Verificación de pausa preventiva en Benavides
  console.log('\n[TEST 4] Verificación de pausa preventiva en Benavides');
  const fwdBenavides = await runForwardCure('BENAVIDES');
  assert(fwdBenavides.status === 'paused', 'runForwardCure omite Benavides y retorna status paused');
  const bwdBenavides = await runBackwardCure('BENAVIDES');
  assert(bwdBenavides.status === 'paused', 'runBackwardCure omite Benavides y retorna status paused');

  console.log('\n==========================================================');
  console.log(`[METRICS] RESULTADOS: ${passed} pasadas, ${failed} fallidas`);
  console.log('==========================================================\n');
