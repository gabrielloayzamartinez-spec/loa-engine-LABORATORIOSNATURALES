...
console.log('[PASS] Caso 2 Pasado: Cliente con venta real preservado como CONVERTIDO.');
...
console.log('[PASS] Caso 3 Pasado: Manejo offline resiliente sin excepciones.');

console.log('[SUCCESS] TODAS LAS PRUEBAS UNITARIAS PASARON EXITOSAMENTE.');
