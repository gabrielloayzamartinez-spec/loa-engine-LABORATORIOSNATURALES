...
export async function runAutonomousAudit(recentLimit = 200, historyLimit = 100) {
  console.log(`\n======================================================`);
  console.log(`[AUDITOR-AUTONOMO] Iniciando patrullaje...`);
  console.log(`======================================================\n`);
  ...
  try {
    ...
    if (histRes.ok) {
      ...
      if (!state.nextPageUrl) {
         console.log(`[AUDITOR-AUTONOMO] [FIN-BASE-DATOS] Fin de la base alcanzado. El próximo ciclo reiniciará el escaneo.`);
      } else {
    ...
    console.log(`\n======================================================`);
    console.log(`[AUDITOR-AUTONOMO] [SUCCESS] Misión cumplida.`);
