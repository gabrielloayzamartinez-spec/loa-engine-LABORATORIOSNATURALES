...
async function fixMonetaryValues() {
  console.log("[MONEY] Iniciando actualización de Monetary Value para clientes Ganados...");
  ...
  console.log(`\n[SUCCESS] Actualización Completada. Se actualizaron ${totalUpdated} oportunidades con su valor real.`);
}
