...
async function auditLiveGHL() {
  console.log('=================================================');
  console.log('[SCAN] AUDITORÍA EN VIVO DE GOHIGHLEVEL (TIEMPO REAL)');
  console.log('=================================================\n');
  ...
  try {
    ...
    if (maestroPipe) {
      console.log(`[TARGET] PIPELINE MAESTRO: ${maestroPipe.name}`);
    ...
    console.log('\n-------------------------------------------------');
    console.log('[USERS] ÚLTIMOS 10 CONTACTOS EN EL CRM:');
    console.log('-------------------------------------------------');
    ...
    for (let idx = 0; idx < contacts.length; idx++) {
      ...
      const phone = c.phone || '[ERROR] SIN TELÉFONO';
      ...
      console.log(`     Asesor Asignado: ${assignedName}`);
      console.log(`    [TAG] Etiquetas: [ ${tags} ]`);
    }

    // 3. Obtener Oportunidades recientes en el Pipeline Maestro
    if (maestroPipe) {
      console.log('\n-------------------------------------------------');
      console.log('[METRICS] OPORTUNIDADES ACTIVAS EN EL PIPELINE MAESTRO:');
      console.log('-------------------------------------------------');
    ...
    console.log('\n=================================================');
    console.log('[OK] AUDITORÍA EN VIVO FINALIZADA CON ÉXITO');
    console.log('=================================================\n');
