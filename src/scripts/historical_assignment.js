...
export async function runHistoricalAssignment() {
  console.log("\n=================================================");
  console.log("[START] MUDANZA HISTÓRICA DE ASIGNACIÓN DE USUARIOS");
  console.log("=================================================\n");

  let url = `https://services.leadconnectorhq.com/contacts/?locationId=${locationId}&limit=100`;
  const allContacts = [];

  console.log("[IMPORT] Consultando todos los contactos del CRM...");
  while (url) {
  ...
  console.log(`\n[METRICS] Total de contactos identificados con etiquetas de página: ${allContacts.length}\n`);
  ...
  console.log(`\n[SUCCESS] MUDANZA HISTÓRICA FINALIZADA:`);
  console.log(`=================================================`);
  ...
  console.log(`[OK] Ya estaban correctamente asignados o sin mapeo: ${stats.alreadyAssigned}`);
  console.log(`=================================================\n\n`);
}
