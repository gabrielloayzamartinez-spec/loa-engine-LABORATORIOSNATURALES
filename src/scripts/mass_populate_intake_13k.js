...
async function runMassIntake13K() {
  console.log("\n============================================================");
  console.log("[START] POBLACIÓN Y TRASLADO MASIVO DEL 100% DE CONTACTOS HACIA INTAKE");
  console.log(` Pipeline ID: ${PIPELINE_ID} (Radar de Auditoría)`);
  console.log(`[IMPORT] Etapa Destino: [IMPORT] Intake / Base Completa (${INTAKE_STAGE_ID})`);
  console.log("============================================================\n");

  // 1. OBTENER TODAS LAS OPORTUNIDADES EXISTENTES EN EL RADAR
  console.log("1 Obteniendo oportunidades existentes en el Radar...");
  ...
  console.log(`\n[OK] Oportunidades existentes mapeadas: ${existingOppsMap.size}`);
  ...
  console.log("2 Descargando la base de 100% de contactos de GoHighLevel...");
  const allContacts = [];
  ...
  console.log(`\n[OK] Total de contactos en GHL descargados: ${allContacts.length}\n`);
  ...
  console.log(`[STAR] Oportunidades nuevas a crear en Intake: ${contactsToCreate.length}`);
  ...
  console.log(`[TARGET] TOTAL DE OPERACIONES A EJECUTAR: ${totalOperations}\n`);
  ...
  if (oppsToMove.length > 0) {
    console.log("[START] Moviendo oportunidades existentes hacia la primera columna...");
  ...
  if (contactsToCreate.length > 0) {
    console.log("\n[START] Creando oportunidades en Intake para el resto de la base completa...");
  ...
  console.log(`\n\n[SUCCESS] ¡POBLACIÓN DEL 100% COMPLETADA CON ÉXITO!`);
  console.log(` Los ${allContacts.length} contactos de tu CRM están ahora concentrados en la primera columna "[IMPORT] Intake / Base Completa (Por Auditar & Distribuir)".\n`);
}
