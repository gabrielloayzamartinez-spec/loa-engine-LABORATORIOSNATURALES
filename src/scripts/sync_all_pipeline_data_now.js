...
async function runGlobalSync() {
  console.log("[START] Iniciando Sincronización Global de Datos al 100% para Capacitación...");
  ...
  console.log(`\n[OK] SINCRONIZACIÓN GLOBAL AL 100% COMPLETADA. Contactos enriquecidos: ${totalUpdated}.`);
}
